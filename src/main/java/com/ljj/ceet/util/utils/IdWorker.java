package com.ljj.ceet.util.utils;
...
/**
 * 
 * @Title: com.ljj.ceet.idworker.IdWorker.java
 * @Package com.lee.utils
 * @Description: 主键id号生成工具类
 * 					调用方法:
 * 					com.ljj.ceet.idworker.IdWorker id = new com.ljj.ceet.idworker.IdWorker();
					id.nextId("");
...
public class IdWorker {
	...
	public IdWorker(long workerId, long datacenterId) {
		...
		if (workerId > maxWorkerId || workerId < 0) {
			throw new IllegalArgumentException(String.format("worker com.ljj.ceet.idworker.Id can't be greater than %d or less than 0", maxWorkerId));
		}
		if (datacenterId > maxDatacenterId || datacenterId < 0) {
			throw new IllegalArgumentException(String.format("datacenter com.ljj.ceet.idworker.Id can't be greater than %d or less than 0", maxDatacenterId));
		}
